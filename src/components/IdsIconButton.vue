...
const iconButtonStyle = reactive({
  ...
  iconWidthHeight: `var(--ids-comp-buttons-size-${props.size}-icon, 16px)`,
});
...
//icons
// width: var(--ids-comp-buttons-size-compact-icon, 16px);
// height: var(--ids-comp-buttons-size-compact-icon, 16px);
...
.compact {
  ...
  font-size: var(--ids-comp-buttons-size-compact-icon, 16px);
  width: var(--ids-comp-icon-button-size-compact-width, 24px);
  height: var(--ids-comp-icon-button-size-compact-height, 24px);
  padding: 0px;// var(--ids-comp-icon-button-size-compact-padding-y, 6px) var(--ids-comp-icon-button-size-compact-padding-x, 8px);
  & > svg { 
  //font-size: var(--ids-comp-buttons-size-spacious-icon, 32px);
  //padding: 5px;
  } 
}
...
.comfortable {
  ...
  font-size: var(--ids-comp-buttons-size-comfortable-icon, 24px);
  width: var(--ids-comp-icon-button-size-comfortable-width, 40px);
  height: var(--ids-comp-icon-button-size-comfortable-height, 40px);
  padding: 0px; // var(--ids-comp-icon-button-size-comfortable-padding-y, 10px) var(--ids-comp-icon-button-size-comfortable-padding-x, 20px);
  & > svg { 
  //font-size: var(--ids-comp-buttons-size-spacious-icon, 32px);
  //padding: 5px;
  } 
...
.spacious {
  ...
  padding: 0px ;//var(--ids-comp-icon-button-size-spacious-padding-y, 16px) var(--ids-comp-icon-button-size-spacious-padding-x, 24px);
  & > svg { 
  //font-size: var(--ids-comp-buttons-size-spacious-icon, 32px);
  //padding: 5px;
  } 
...
.filled {
  ...
  &:disabled {
    color: var(--ids-comp-icon-button-filled-color-fg-disabled);
  }
}
...
.outlined {
  color: var(--ids-comp-icon-button-filled-color-fg-primary-enabled);
  border: var(--ids-comp-icon-button-size-comfortable-border, 1px) solid var(--ids-comp-icon-button-outlined-color-border-success-enabled, #22C55E);
  &:disabled {
    color: var(--ids-comp-icon-button-filled-color-fg-disabled);
  }
}
